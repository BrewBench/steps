...
(function e(t, n, i) {
  function r(l, u) {
    if (!n[l]) {
      if (!t[l]) {
        var a = typeof require == "function" && require;if (!u && a) return a(l, !0);if (s) return s(l, !0);var o = new Error("Cannot find module '" + l + "'");throw o.code = "MODULE_NOT_FOUND", o;
        ...
        var u, a, o, f, c, p, h;if (t == null) {
          ...
          if (e instanceof Array) {
            for (u = 0, o = e.length; u < o; u++) {
              p = e[u];h = t - 1 <= 0 || (typeof p === "undefined" ? "undefined" : _typeof(p)) !== "object" || s.isEmpty(p);f += c + "-" + (h ? " " : "\n") + this.dump(p, t - 1, h ? 0 : n + this.indentation, i, l) + (h ? "\n" : "");
            }
          } else {
            for (a in e) {
              p = e[a];h = t - 1 <= 0 || (typeof p === "undefined" ? "undefined" : _typeof(p)) !== "object" || s.isEmpty(p);f += c + r.dump(a, i, l) + ":" + (h ? " " : "\n") + this.dump(p, t - 1, h ? 0 : n + this.indentation, i, l) + (h ? "\n" : "");
            }
          }
        }return f;
      };return e;
    ...
    var i,
      ...
      function e() {}e.REGEX_QUOTED_STRING = "(?:\"(?:[^\"\\\\]*(?:\\\\.[^\"\\\\]*)*)\"|'(?:[^']*(?:''[^']*)*)')";e.PATTERN_TRAILING_COMMENTS = new a("^\\s*#.*$");e.PATTERN_QUOTED_SCALAR = new a("^" + e.REGEX_QUOTED_STRING);e.PATTERN_THOUSAND_NUMERIC_SCALAR = new a("^(-|\\+)?[0-9,]+(\\.[0-9]+)?$");e.PATTERN_SCALAR_BY_DELIMITERS = {};e.settings = {};e.configure = function (e, t) {
        ...
        var s, u, o, p, h, E, T, A, _;if (t == null) {
          t = null;
        }if (n == null) {
          n = ['"', "'"];
        }if (i == null) {
          ...
          p = this.parseQuotedScalar(e, i);s = i.i;if (t != null) {
            _ = f.ltrim(e.slice(s), " ");if (!(T = _.charAt(0), c.call(t, T) >= 0)) {
              throw new l("Unexpected characters (" + e.slice(s) + ").");
            }
          }
        } else {
          if (!t) {
            p = e.slice(s);s += p.length;A = p.indexOf(" #");if (A !== -1) {
              p = f.rtrim(p.slice(0, A));
            }
          } else {
            u = t.join("|");h = this.PATTERN_SCALAR_BY_DELIMITERS[u];if (h == null) {
              h = new a("^(.+?)(" + u + ")");this.PATTERN_SCALAR_BY_DELIMITERS[u] = h;
            }if (o = h.exec(e.slice(s))) {
              p = o[1];s += p.length;
            } else {
              throw new l("Malformed inline YAML string (" + e + ").");
            }
          }if (r) {
            p = this.evaluateScalar(p, i);
          }
        }i.i = s;return p;
        ...
        var n, i, r, s, u, a, o, c, p, h, E;e = f.trim(e);p = e.toLowerCase();switch (p) {case "null":case "":case "~":
                  ...
                  a = p.slice(0, u);
                    ...
                    if (t == null) {
                      ...
                      E = f.rtrim(e);u = E.indexOf(" ");if (u === -1) {
                        ...
                        h = f.ltrim(E.slice(u + 1));if (!(h.length > 0)) {
                          h = null;
                        }return o(E.slice(0, u), h);
                      }
                    }if (r) {
    ...
    var i, r, s, l, u, a;i = e("./Inline");u = e("./Pattern");a = e("./Utils");r = e("./Exception/ParseException");s = e("./Exception/ParseMore");l = function () {
      e.prototype.PATTERN_FOLDED_SCALAR_ALL = new u("^(?:(?<type>![^\\|>]*)\\s+)?(?<separator>\\||>)(?<modifiers>\\+|\\-|\\d+|\\+\\d+|\\-\\d+|\\d+\\+|\\d+\\-)?(?<comments> +#.*)?$");e.prototype.PATTERN_FOLDED_SCALAR_END = new u("(?<separator>\\||>)(?<modifiers>\\+|\\-|\\d+|\\+\\d+|\\-\\d+|\\d+\\+|\\d+\\-)?(?<comments> +#.*)?$");e.prototype.PATTERN_SEQUENCE_ITEM = new u("^\\-((?<leadspaces>\\s+)(?<value>.+?))?\\s*$");e.prototype.PATTERN_ANCHOR_VALUE = new u("^&(?<ref>[^ ]+) *(?<value>.*)");e.prototype.PATTERN_COMPACT_NOTATION = new u("^(?<key>" + i.REGEX_QUOTED_STRING + "|[^ '\"\\{\\[].*?) *\\:(\\s+(?<value>.+?))?\\s*$");e.prototype.PATTERN_MAPPING_ITEM = new u("^(?<key>" + i.REGEX_QUOTED_STRING + "|[^ '\"\\[\\{].*?) *\\:(\\s+(?<value>.+?))?\\s*$");e.prototype.PATTERN_DECIMAL = new u("\\d+");e.prototype.PATTERN_INDENT_SPACES = new u("^ +");e.prototype.PATTERN_TRAILING_LINES = new u("(\n*)$");e.prototype.PATTERN_YAML_HEADER = new u("^\\%YAML[: ][\\d\\.]+.*\n", "m");e.prototype.PATTERN_LEADING_COMMENTS = new u("^(\\#.*?\n)+", "m");e.prototype.PATTERN_DOCUMENT_MARKER_START = new u("^\\-\\-\\-.*?\n", "m");e.prototype.PATTERN_DOCUMENT_MARKER_END = new u("^\\.\\.\\.\\s*$", "m");e.prototype.PATTERN_FOLDED_SCALAR_BY_INDENTATION = {};e.prototype.CONTEXT_NONE = 0;e.prototype.CONTEXT_SEQUENCE = 1;e.prototype.CONTEXT_MAPPING = 2;function e(e) {
        ...
        var l, u, o, f, c, p, h, E, T, A, _, L, d, N, g, R, x, C, m, I, S, w, v, y, P, b, D, O, M, G, U, X, F, k, H, j, Y, B, Q;if (n == null) {
          n = false;
        }if (s == null) {
          s = null;
        }this.currentLineNb = -1;this.currentLine = "";this.lines = this.cleanup(t).split("\n");p = null;c = this.CONTEXT_NONE;u = false;while (this.moveToNextLine()) {
          if (this.isCurrentLineEmpty()) {
            ...
            if (this.CONTEXT_MAPPING === c) {
            ...
            }c = this.CONTEXT_SEQUENCE;if (p == null) {
              p = [];
              ...
              if (this.currentLineNb < this.lines.length - 1 && !this.isNextLineUnIndentedCollection()) {
                f = this.getRealCurrentLineNb() + 1;X = new e(f);X.refs = this.refs;p.push(X.parse(this.getNextEmbedBlock(null, true), n, s));
              } else {
                p.push(null);
              }
            } else {
              if (((F = Q.leadspaces) != null ? F.length : void 0) && (b = this.PATTERN_COMPACT_NOTATION.exec(Q.value))) {
                ...
                }p.push(X.parse(o, n, s));
              } else {
                p.push(this.parseValue(Q.value, n, s));
              }
            }
            ...
            if (this.CONTEXT_SEQUENCE === c) {
            ...
            }c = this.CONTEXT_MAPPING;if (p == null) {
              p = {};
            }i.configure(n, s);try {
              x = i.parseScalar(Q.key);
            } catch (E) {
              h = E;h.parsedLine = this.getRealCurrentLineNb() + 1;h.snippet = this.currentLine;throw h;
            }if ("<<" === x) {
              D = true;u = true;if (((k = Q.value) != null ? k.indexOf("*") : void 0) === 0) {
                j = Q.value.slice(1);if (this.refs[j] == null) {
                  ...
                  for (L = g = 0, I = Y.length; g < I; L = ++g) {
                    t = Y[L];if (p[M = String(L)] == null) {
                      p[M] = t;
                    }
                  }
                } else {
                  ...
                  for (C = 0, S = G.length; C < S; C++) {
                    U = G[C];if ((typeof U === "undefined" ? "undefined" : _typeof(U)) !== "object") {
                      ...
                      for (L = P = 0, w = U.length; P < w; L = ++P) {
                        t = U[L];R = String(L);if (!p.hasOwnProperty(R)) {
                          p[R] = t;
                        }
                      }
                    } else {
                      for (x in U) {
                        t = U[x];if (!p.hasOwnProperty(x)) {
                          p[x] = t;
                        }
                      }
                    }
              ...
              if (!this.isNextLineIndented() && !this.isNextLineUnIndentedCollection()) {
                ...
                f = this.getRealCurrentLineNb() + 1;X = new e(f);X.refs = this.refs;B = X.parse(this.getNextEmbedBlock(), n, s);if (u || p[x] === void 0) {
                  p[x] = B;
                }
              }
            } else {
              B = this.parseValue(Q.value, n, s);if (u || p[x] === void 0) {
                p[x] = B;
              }
            }
          } else {
            y = this.lines.length;if (1 === y || 2 === y && a.isEmpty(this.lines[1])) {
              try {
                ...
                h = T;h.parsedLine = this.getRealCurrentLineNb() + 1;h.snippet = this.currentLine;throw h;
                ...
                if (t instanceof Array) {
                  ...
                  p = [];for (O = 0, v = t.length; O < v; O++) {
                    l = t[O];p.push(this.refs[l.slice(1)]);
                  }t = p;
                }
              }return t;
              ...
              try {
                ...
                h = A;h.parsedLine = this.getRealCurrentLineNb() + 1;h.snippet = this.currentLine;throw h;
              }
            }throw new r("Unable to parse.", this.getRealCurrentLineNb() + 1, this.currentLine);
          }if (N) {
            if (p instanceof Array) {
              this.refs[N] = p[p.length - 1];
            } else {
              m = null;for (x in p) {
                m = x;
              }this.refs[N] = p[m];
        ...
        var l, u, o, f, c, p, h, E, T;if (0 === e.indexOf("*")) {
          p = e.indexOf("#");if (p !== -1) {
            e = e.substr(1, p - 2);
          } else {
            e = e.slice(1);
          ...
          c = (h = f.modifiers) != null ? h : "";o = Math.abs(parseInt(c));if (isNaN(o)) {
            o = 0;
        ...
        var r, s, l, o, f, c, p, h, E, T;if (n == null) {
          n = "";
        }if (i == null) {
          i = 0;
        }p = this.moveToNextLine();if (!p) {
          return "";
        }r = this.isCurrentLineBlank();T = "";while (p && r) {
          if (p = this.moveToNextLine()) {
          ...
          h = this.PATTERN_FOLDED_SCALAR_BY_INDENTATION[i];if (h == null) {
            h = new u("^ {" + i + "}(.*)$");e.prototype.PATTERN_FOLDED_SCALAR_BY_INDENTATION[i] = h;
          }while (p && (r || (f = h.exec(this.currentLine)))) {
            if (r) {
        ...
        var t, n, i, r, s, l, u, o, f, c, p, h, E, T;if (e.indexOf("\r") !== -1) {
          e = e.split("\r\n").join("\n").split("\r").join("\n");
        }t = 0;c = this.PATTERN_YAML_HEADER.replaceAll(e, ""), e = c[0], t = c[1];this.offset += t;p = this.PATTERN_LEADING_COMMENTS.replaceAll(e, "", 1), T = p[0], t = p[1];if (t === 1) {
          this.offset += a.subStrCount(e, "\n") - a.subStrCount(T, "\n");e = T;
        }h = this.PATTERN_DOCUMENT_MARKER_START.replaceAll(e, "", 1), T = h[0], t = h[1];if (t === 1) {
    ...
    var i,
      ...
      function t() {}t.REGEX_LEFT_TRIM_BY_CHAR = {};t.REGEX_RIGHT_TRIM_BY_CHAR = {};t.REGEX_SPACES = /\s+/g;t.REGEX_DIGITS = /^\d+$/;t.REGEX_OCTAL = /[^0-7]/gi;t.REGEX_HEXADECIMAL = /[^a-f0-9]/gi;t.PATTERN_DATE = new i("^" + "(?<year>[0-9][0-9][0-9][0-9])" + "-(?<month>[0-9][0-9]?)" + "-(?<day>[0-9][0-9]?)" + "(?:(?:[Tt]|[ \t]+)" + "(?<hour>[0-9][0-9]?)" + ":(?<minute>[0-9][0-9])" + ":(?<second>[0-9][0-9])" + "(?:.(?<fraction>[0-9]*))?" + "(?:[ \t]*(?<tz>Z|(?<tz_sign>[-+])(?<tz_hour>[0-9][0-9]?)" + "(?::(?<tz_minute>[0-9][0-9]))?))?)?" + "$", "i");t.LOCAL_TIMEZONE_OFFSET = new Date().getTimezoneOffset() * 60 * 1e3;t.trim = function (e, t) {
        ...
        var t, n, i, r, s, l, u, a, o, f, c, p;if (!(e != null ? e.length : void 0)) {
          return null;
        }s = this.PATTERN_DATE.exec(e);if (!s) {
          return null;
        }p = parseInt(s.year, 10);u = parseInt(s.month, 10) - 1;n = parseInt(s.day, 10);if (s.hour == null) {
          t = new Date(Date.UTC(p, u, n));return t;
        ...
        }t = new Date(Date.UTC(p, u, n, r, l, a, i));if (c) {
    ...
    var i, r, s, l;r = e("./Parser");i = e("./Dumper");s = e("./Utils");l = function () {
      function t() {}t.parse = function (e, t, n) {
        if (t == null) {
          t = false;
        }if (n == null) {
          n = null;
        ...
        var t;t = function t(e, _t) {
          return e.exports = YAML.parseFile(_t);
        };if ((typeof e !== "undefined" && e !== null ? e.extensions : void 0) != null) {
          e.extensions[".yml"] = t;return e.extensions[".yaml"] = t;
        }
